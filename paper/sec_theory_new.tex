...
which on the physical domain of the EMIT table spans about twenty-four decades, and thirteen above
the floor $10^{-12}T_{\rm train}$ of Section~\ref{sec:tq-domain}. The bound \eqref{eq:Jtau-bound}
