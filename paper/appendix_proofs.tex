...
With $a=s=0$ and exact $t$ and $s$, the stack's path-radiance error is
...
\[
E(w_f)=\frac{b^2c^2\,(c^2\delta^4+b^2)}{2(b^2+c^2\delta^2)^2}\to\frac{c^2}{2},\qquad
E(w_r)=\frac{b^2c^2}{2(b^2+c^2)},
\]
whose ratio tends to $(b^2+c^2)/b^2$, and $F(w_f)\le F(w_r)$ because $w_f$ minimizes $F$. Finally, with
