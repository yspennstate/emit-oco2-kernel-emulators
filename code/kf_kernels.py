...
p.add_argument("--problem", required=True, choices=["emit", "oco2", "structmech", "bench"])
...
import bench_adapter
bench_adapter.add_args(p)
args = p.parse_args()
...
t0 = time.time()
if args.problem == "bench":
    D, _ = bench_adapter.load(args)
elif args.problem == "emit":
